...
from forms import *
jwt_token = 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InQ3N2JJcTR6OUtwcVQ1QXYyaWlZdCJ9..COPdnV6S4JKk_hSoCNuXF0VQWIz0EFvrTezjxjECSgUD5lKomLErACn4Xk25bQQvZJhZeVnB70zrDUsFe0F7_-pO_QHVbEtbVrXiD6sVYfFPRaZtD4xfWR5tnNiy7VTj38PM1oPTKsGfoOrwgDh8EB9Bto02ggKZhShR273mKzJc5HFk4oY3bjLp2x-zgwxkv4X6YqsogGb-RlVt5xbgJKskqC3KF1I0dXLogThFyRnj6ncnUtvA1JMt5sfCUb8uNB8h6yFZ0UscaiQdTePSqOXoearVNSXukdgIEgRw_cK0EUdiZBnozLjtEJ0yItAj4GqjZltol1fi4ttYXpxUAg'
    ...
    def test_create_product(self):
        ...
        with open(path_img, 'rb') as img:
            ...
            response = self.client().post('/api/products/create', 
                                            data=dict(
                                                name='test name',
                                                # image = dict(image = (name_img,img,'multipart/form-data',{'Expires': '0'})),
                                                description='test description',
